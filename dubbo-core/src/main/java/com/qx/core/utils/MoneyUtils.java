...
public class MoneyUtils {
  ...
  /**
    ...
    * 运算上下文（设置精度、舍入规则）
    */
    public static final MathContext MATHCONTEXT = new MathContext(PRECISION, 
...
SAVEROUNDINGMODE);
    ...
    */
     ...
     * @return
     */
     public static BigDecimal add(String addend, String augend, String augend2){
         BigDecimal decimalAddend = newBigDecimal(addend);
         BigDecimal decimalAugend = newBigDecimal(augend);
         BigDecimal decimalAugend2 = newBigDecimal(augend2);
         return formatMoney(decimalAddend.add(decimalAugend, MATHCONTEXT).add(decimalAugend2));
     }
...
MATHCONTEXT));
    ...
    * @return
    */
    public static BigDecimal formatInterestRateToShow(BigDecimal result, BigDecimal 
    ...
    */
    public static String formatToString(BigDecimal result){
        if(result == null){
            ...
            return STRIPTRAILINGZEROS ? result.stripTrailingZeros().toPlainString() : 
