...
import com.qx.core.common.enums.ResponseMsgEnum;
...
//	private static GsonBuilder GSON_BUILDER = new GsonBuilder();
	private static ObjectMapper JSON_BUILEDER = new ObjectMapper();
...
//		logger.info("请求返回数据:{}", result);
		String result = null;
		try {
			JSON_BUILEDER.setSerializationInclusion(JsonInclude.Include.NON_NULL);
			result = JSON_BUILEDER.writeValueAsString(this);
